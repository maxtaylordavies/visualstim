...
from constants import WINDOW_HEIGHT, WINDOW_WIDTH, PIXEL_SIZE, DISP_WIDTH
...
def main():
    # create window
    win = visual.Window(fullscr=True, units="norm", color=[0, 0, 0])
    frameRate = win.getActualFrameRate()

    # create texture for drum grating
    texture = getTexture(frameRate)
